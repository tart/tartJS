 ...
 * @param {?tart.components.mobile.Model=} opt_model Data model.
 * @param {?tart.components.mobile.View=} opt_view View object.
 */
tart.components.mobile.Controller = function(opt_model, opt_view) {
    goog.base(this, opt_model || new this.modelClass(), opt_view || new this.viewClass());
    this.buildDOM();
    this.bindEvents();
};
...
/**
 * Build DOM for the attached view.
 *
 * @return {Element} generates a DOM of attached View object.
 */
...
/**
 * View class of mobile component.
 *

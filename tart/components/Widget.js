...
tart.components.Widget.prototype.render = function () {
	var el = goog.dom.getElement(this.componentId_);
	if (!el) el = goog.dom.query('#' + this.componentId_, rd.current.contentDocument)[0];
    el.appendChild(this.controller.getDOM());
};
